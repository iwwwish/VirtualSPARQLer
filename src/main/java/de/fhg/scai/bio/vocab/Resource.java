...
/**
 * This is a class for Resource (terminology in RDF,SPARQL language).
 *
...
public class Resource {
    ...
    public static String TYPE_ClassMap = "d2rq:ClassMap";
    public static String TYPE_PropertyBridge = "d2rq:PropertyBridge";
